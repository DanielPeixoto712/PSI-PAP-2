...
@section ('produtos')
 <div class="col-lg-9">
        ...
        <div align="center">
        <a href="{{route('sparcos.create')}}"><button type="button" class="btn btn-outline-primary">Criar</button></a>
</div><br>
        <div class="row">

         @foreach($sparcos as $sparco)
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  ...
                  <a href="{{route('sparcos.show', ['id'=>$sparco->id_sparco])}} "class="list-group-item"  >{{$sparco->volante}}</a>
                </h4>
                <h5>{{$sparco->preco}} €</h5>
                <p class="card-text">{{$sparco->info}}</p>
              </div>
