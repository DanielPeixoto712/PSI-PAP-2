...
@section ('produtos')
 <div class="col-lg-9">
        ...
        <div align="center">
        <a href="{{route('aps.create')}}"><button type="button" class="btn btn-outline-primary">Criar</button></a>
</div><br>
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  ...
                  <a href="{{route('aps.show', ['id'=>$ap->id_ap])}} "class="list-group-item"  >{{$ap->suspenssao}}</a>
                </h4>
                <h5>{{$ap->preco}} €</h5>
                <p class="card-text">{{$ap->info}}</p>
              </div>
