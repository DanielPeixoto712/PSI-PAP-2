...
@section ('produtos')
 <div class="col-lg-9">
        ...
        <div align="center">
        <a href="{{route('bomps.create')}}"><button type="button" class="btn btn-outline-primary">Criar</button></a>
</div><br>
        <div class="row">

         @foreach($bomps as $bomp)
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  ...
                  <a href="{{route('bomps.show', ['id'=>$bomp->id_bomp])}} "class="list-group-item"  >{{$bomp->backet}}</a>
                </h4>
                <h5>{{$bomp->preco}} €</h5>
                <p class="card-text">{{$bomp->info}}</p>
              </div>
